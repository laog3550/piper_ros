...
> This repository includes the confirmed Pi05 four-arm CAN mapping. See
> [docs/PI05_CAN_MAPPING.md](docs/PI05_CAN_MAPPING.md) for interfaces, USB
> ports, adapter identities, and the Python verification utility.
